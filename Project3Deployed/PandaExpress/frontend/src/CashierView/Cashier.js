...
export default function Cashier({ onNavigateToManager }) {
  ...
  function onSizeSelected(e) {
    ...
    setCombos(prev => [...prev, { size, items: [], sideCount: 0, entreeCount: 0, maxSideCount: sideCount, maxEntreeCount: entreeCount }]);
  ...
  async function onSubmitOrder() {
    ...
    const order = { combos, appetizers, drinks, totalPrice: total };
  ...
  function deleteComboItem(comboIdx, itemIdx) {
    setCombos(prev => {
      ...
      // Adjust counts based on what was removed
      // track whether each item is a side or entree
      if (copy[comboIdx].sideCount > 0) copy[comboIdx].sideCount--;
      if (copy[comboIdx].entreeCount > 0) copy[comboIdx].entreeCount--;
        ...
        <div className="main-area" style={{flex: 1, minWidth: 0}}>
          <div className="top-controls">
            <div className="size-row">
              <button className="btn-size" data-size="Bowl" onClick={onSizeSelected}>Bowl</button>
              <button className="btn-size" data-size="Plate" onClick={onSizeSelected}>Plate</button>
              <button className="btn-size" data-size="Bigger Plate" onClick={onSizeSelected}>Bigger Plate</button>
            </div>
