...
export default function Customer({ onReturnToCashier, onNavigateToManager }){
    ...
    const initGoogleTranslate = () => {
            ...
            try {
                ...
                if (typeof ctor === 'function') {
                    // Preferred usage
                    new ctor({ pageLanguage: 'en' }, 'google_translate_element');
                    ...
                    if (typeof window.google.translate.TranslateElement.init === 'function') {
                        window.google.translate.TranslateElement.init({ pageLanguage: 'en' }, 'google_translate_element');
                    } else {
            ...
            // After widget initializes, try to preserve/apply the previously
    ...
    function resetTranslation(){
        ...
        // Re-init widget to ensure full-page reset
        try{
    ...
    useEffect(() => {
      ...
      useEffect(() => {
            // Ensure the page defaults to English before any translate widget runs.
                ...
                if (!window.google || !window.google.translate) {
                    // Ensure the global callback is set so the widget calls our init
                    // function. After init runs, also attempt to enforce English.
            ...
            useEffect(() => {
                // When the size page opens, ensure any previously selected language
                // is applied to newly-rendered content. 
